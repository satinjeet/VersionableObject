...
const chai_1 = __webpack_require__(16);
describe("Suite 1: Base test suite for VObject test cases", () => {
    ...
    it("start Object with initial version and value, no patch", () => {
        ...
        chai_1.expect(o1.version.is()).to.equal('1.0.1');
...
describe("Suite 2: Test use cases", () => {
    it("2.1 : Get object state", () => {
        ...
        chai_1.expect(state.prop4).to.contain(1);
        chai_1.expect(state.prop4).to.contain(2);
...
const version_1 = __webpack_require__(2);
const DefineGetterAndSetter_1 = __webpack_require__(46);
class BaseObject {
    constructor() {
...
exports.objDisplay = __webpack_require__(8);
